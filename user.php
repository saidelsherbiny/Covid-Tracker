...
<body>
    ...
    <section class="py-5 mt-5">
        <div class="container" type="button"><img src="assets/img/clipboard-image.png" style="padding-bottom: 2px;" width="182" height="226">
            <h2 class="fw-bold">Username</h2>
            <h2 class="fw-bold">name</h2>
            <h2 class="fw-bold">email</h2>
            <h2 class="fw-bold">privilege</h2>
                        ...
                        <div class="col mb-5">
                            <div class="card shadow-sm">
                                <div class="card-body px-4 py-5 px-md-5">
                                    ...
                                    <p class="text-muted card-text mb-4">Erat netus est hendrerit, nullam et quis ad cras porttitor iaculis. Bibendum vulputate cras aenean.</p><button class="btn btn-primary shadow" type="button">read</button><button class="btn btn-primary shadow" type="button">delete</button>
                                </div>
                            </div>
                        </div>
                        <div class="col mb-5">
