...
if(isset($_POST["add"]) ){
    $add_article= $conn->prepare("INSERT INTO wuc353_1.User (U_ID,citizenship,firstName,lastName,phoneNumber,email,dateOfbirth,username,password, privilege)
                                                        VALUES ( :U_ID, :citizenship, :firstName, :lastName, :phoneNumber, :email, :dateOfbirth,  :username,:password,privilege);" );
