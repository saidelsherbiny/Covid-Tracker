...
if (isset($_POST["add"])) {
    $add_country = $conn->prepare("INSERT INTO wuc353_1.Country (C_Name,C_ID)
                                                      VALUES ( :C_Name, :C_ID);");
    $add_country->bindParam(':C_ID', $_POST["C_ID"]);
    $add_country->bindParam(':C_Name', $_POST["C_Name"]);

//    $add_user->bindParam(':add', $edit);
//    $add_user->bindParam(':edit', $edit);
//    $add_user->bindParam(':delete', $edit);
//
//    if ($_POST["privilege"] = 'regular') {
//        $edit = 0;
//    } else {
//        $edit = 1;
//    }
...
<nav class="navbar navbar-dark navbar-expand-md fixed-top navbar-shrink py-3" id="mainNav">
    <div class="container"><a class="navbar-brand d-flex align-items-center" href="/"><span
                    ...
                    </svg></span><span><strong>Comp353 Best group ever</strong><br></span></a>
    ...
    <div class="container">
        <div class="row mb-5">
            <div class="col-md-8 col-xl-6 text-center mx-auto">
                <p class="fw-bold text-success mb-2">add Country</p>
        ...
        <div class="row d-flex justify-content-center">
            <div class="col-md-6 col-xl-4">
                <div>
                    <form class="p-3 p-xl-4" action="./add_country.php" method="post">
                    <div class="mb-3">
                            <input type="number" list="C_ID"/>
                            <datalist id="C_ID" name="C_ID">
                                <option>1</option>
                                <option>2</option>
                                <option>3</option>
                                <option>4</option>
                        ...
                        <div class="mb-3"><input class="form-control" type="text" id="C_Name" name="C_Name"
                                                 placeholder="Country name"></div>
                        <div>
                            <button class="btn btn-primary shadow d-block w-100" type="submit" name="add">add</button>
                        </div>
                    </form>
