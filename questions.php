...
$q1 = $conn->prepare('SELECT distinct wuc353_1.Possess.dateUpdated, Country.C_Name, ProStaTer.Population
from ProStaTer, Country, Possess
where Country.C_Name ="Canada"
and ProStaTer.PSTCountry_Name="Canada"
and Country.C_Name =wuc353_1.Possess.P_Name
Order by dateUpdated Desc ;');
$q2 = $conn->prepare('SELECT * FROM wuc353_1.Article as article');
...
<body style="/*background: url(&quot;design.jpg&quot;);*/background-position: 0 -60px;">
    ...
    <?php
                            for ($x = 0; $x < 6; $x++) {
                                $row = $q1->fetch(PDO::FETCH_ASSOC, PDO::FETCH_ORI_NEXT) ?>
                                <div class="col mb-4">
