...
try {
    if (isset($_POST["login"])) {
        if (empty($_POST["username"]) || empty($_POST["pass"])) {
            ...
            $query = "SELECT * FROM wuc353_1.User WHERE username = :username AND pass = :pass";
        ...
        <div class="container py-5">
            <div class="row mb-4 mb-lg-5">
                <div class="col-md-8 col-xl-6 text-center mx-auto">
                    ...
                    <h2 class="fw-bold">Welcome to the covid-19 </h2>
                </div>
            </div>
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="card">
                        <div class="card-body text-center d-flex flex-column align-items-center">
                            ...
                            <form method="post">
                                <div class="mb-3"><input class="form-control" type="text" name="username" placeholder="username" style="color:black;"></div>
                                <div class="mb-3"><input class="form-control" type="pass" name="pass" placeholder="Password" style="color:black;"></div>
                                <div class="mb-3"><button class="btn btn-primary shadow d-block w-100" type="submit" name="login">Log in</button></div>
                            </form>
                        </div>
                    </div>
                </div>
